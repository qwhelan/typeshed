...
def detect_encoding(readline: Callable[[int], bytes]) -> Tuple[str, Sequence[bytes]]: ...
def tokenize(readline: Callable[[int], bytes]) -> Generator[TokenInfo, None, None]: ...
def generate_tokens(readline: Callable[[int], str]) -> Generator[TokenInfo, None, None]: ...  # undocumented
